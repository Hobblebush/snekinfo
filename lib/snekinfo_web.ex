defmodule SnekinfoWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: SnekinfoWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/snekinfo_web/templates",
        namespace: SnekinfoWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {SnekinfoWeb.LayoutView, "live.html"}
