defmodule SnekinfoWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use SnekinfoWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import SnekinfoWeb.ConnCase

      alias SnekinfoWeb.Router.Helpers, as: Routes

      # The default endpoint for testing
      @endpoint SnekinfoWeb.Endpoint
    end
  end
  ...
  def log_in_user(conn, user) do
    token = Snekinfo.Users.generate_user_session_token(user)
